  ...
  module Apis
    module RedisV1beta1
      ...
      class AddAuthTokenRequest
        # @private
        class Representation < Google::Apis::Core::JsonRepresentation
          property :auth_token, as: 'authToken', class: Google::Apis::RedisV1beta1::AuthToken, decorator: Google::Apis::RedisV1beta1::AuthToken::Representation
      ...
      class ListAclPoliciesResponse
        # @private
        class Representation < Google::Apis::Core::JsonRepresentation
          collection :acl_policies, as: 'aclPolicies', class: Google::Apis::RedisV1beta1::AclPolicy, decorator: Google::Apis::RedisV1beta1::AclPolicy::Representation
      ...
      class ListAuthTokensResponse
        # @private
        class Representation < Google::Apis::Core::JsonRepresentation
          collection :auth_tokens, as: 'authTokens', class: Google::Apis::RedisV1beta1::AuthToken, decorator: Google::Apis::RedisV1beta1::AuthToken::Representation
      ...
      class ListTokenAuthUsersResponse
        ...
        class Representation < Google::Apis::Core::JsonRepresentation
          property :next_page_token, as: 'nextPageToken'
          collection :token_auth_users, as: 'tokenAuthUsers', class: Google::Apis::RedisV1beta1::TokenAuthUser, decorator: Google::Apis::RedisV1beta1::TokenAuthUser::Representation
      ...
      class RegionalManagedCertificateAuthority
        # @private
        class Representation < Google::Apis::Core::JsonRepresentation
          collection :ca_certs, as: 'caCerts', class: Google::Apis::RedisV1beta1::RegionalCertChain, decorator: Google::Apis::RedisV1beta1::RegionalCertChain::Representation
      ...
      class ResourceMaintenanceInfo
        # @private
        class Representation < Google::Apis::Core::JsonRepresentation
          property :current_version_release_date, as: 'currentVersionReleaseDate', class: Google::Apis::RedisV1beta1::Date, decorator: Google::Apis::RedisV1beta1::Date::Representation
