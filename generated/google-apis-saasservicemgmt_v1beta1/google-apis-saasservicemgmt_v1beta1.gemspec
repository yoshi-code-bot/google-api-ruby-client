require File.expand_path("lib/google/apis/saasservicemgmt_v1beta1/gem_version", __dir__)
gem_version = Google::Apis::SaasservicemgmtV1beta1::GEM_VERSION

Gem::Specification.new do |gem|
  gem.name = "google-apis-saasservicemgmt_v1beta1"
  gem.version = gem_version
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for App Lifecycle Manager API V1beta1"
  gem.description =
      "This is the simple REST client for App Lifecycle Manager API V1beta1." \
      ...
      " this client to access the App Lifecycle Manager API, but note that some" \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-saasservicemgmt_v1beta1/v#{gem_version}",
