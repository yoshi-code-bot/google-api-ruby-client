  ...
  module Apis
    module OsconfigV1
      ...
      class WeekDayOfMonth
        ...
        # and `day_of_week` values point to the second Tuesday of the month and the `
        # day_offset` value is set to `3`, patch deployment takes place three days after
        # the second Tuesday of the month. If this value is negative, for example -5,
        # patches are deployed five days before the second Tuesday of the month. Allowed
