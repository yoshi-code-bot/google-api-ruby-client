  ...
  module Apis
    module MigrationcenterV1
      ...
      class MigrationCenterAPIService < Google::Apis::Core::BaseService
        DEFAULT_ENDPOINT_TEMPLATE = "https://migrationcenter.$UNIVERSE_DOMAIN$/"
        ...
        # @param [Google::Apis::MigrationcenterV1::AssetsExportJob] assets_export_job_object
        ...
        def create_project_location_assets_export_job(parent, assets_export_job_object = nil, assets_export_job_id: nil, request_id: nil, fields: nil, quota_user: nil, options: nil, &block)
          command = make_simple_command(:post, 'v1/{+parent}/assetsExportJobs', options)
          command.request_representation = Google::Apis::MigrationcenterV1::AssetsExportJob::Representation
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google::Apis::MigrationcenterV1::AssetsExportJob] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google::Apis::MigrationcenterV1::AssetsExportJob]
        #
        # @raise [Google::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def get_project_location_assets_export_job(name, fields: nil, quota_user: nil, options: nil, &block)
          command = make_simple_command(:get, 'v1/{+name}', options)
          command.response_representation = Google::Apis::MigrationcenterV1::AssetsExportJob::Representation
          command.response_class = Google::Apis::MigrationcenterV1::AssetsExportJob
          command.params['name'] = name unless name.nil?
          command.query['fields'] = fields unless fields.nil?
          command.query['quotaUser'] = quota_user unless quota_user.nil?
          execute_or_queue_command(command, &block)
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google::Apis::MigrationcenterV1::ListAssetsExportJobsResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google::Apis::MigrationcenterV1::ListAssetsExportJobsResponse]
        #
        # @raise [Google::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def list_project_location_assets_export_jobs(parent, page_size: nil, page_token: nil, fields: nil, quota_user: nil, options: nil, &block)
          command = make_simple_command(:get, 'v1/{+parent}/assetsExportJobs', options)
          command.response_representation = Google::Apis::MigrationcenterV1::ListAssetsExportJobsResponse::Representation
          command.response_class = Google::Apis::MigrationcenterV1::ListAssetsExportJobsResponse
          command.params['parent'] = parent unless parent.nil?
          command.query['pageSize'] = page_size unless page_size.nil?
          command.query['pageToken'] = page_token unless page_token.nil?
          command.query['fields'] = fields unless fields.nil?
        ...
        # @param [String] name
        #   Required. Name of the resource.
        # @param [Google::Apis::MigrationcenterV1::RunAssetsExportJobRequest] run_assets_export_job_request_object
        # @param [String] fields
        #   Selector specifying which fields to include in a partial response.
        # @param [String] quota_user
        #   Available to use for quota purposes for server-side applications. Can be any
        ...
        def run_assets_export_job(name, run_assets_export_job_request_object = nil, fields: nil, quota_user: nil, options: nil, &block)
          ...
          command.request_representation = Google::Apis::MigrationcenterV1::RunAssetsExportJobRequest::Representation
