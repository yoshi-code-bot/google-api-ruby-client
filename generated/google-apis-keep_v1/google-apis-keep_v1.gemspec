require File.expand_path("lib/google/apis/keep_v1/gem_version", __dir__)
gem_version = Google::Apis::KeepV1::GEM_VERSION

Gem::Specification.new do |gem|
  gem.name = "google-apis-keep_v1"
  gem.version = gem_version
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for Google Keep API V1"
  gem.description =
      "This is the simple REST client for Google Keep API V1." \
      ...
      " this client to access the Google Keep API, but note that some" \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-keep_v1/v#{gem_version}",
