  ...
  module Apis
    module MetastoreV1alpha
      ...
      class DataprocMetastoreService < Google::Apis::Core::BaseService
        ...
        #   location_id`.
        # @param [Google::Apis::MetastoreV1alpha::Federation] federation_object
        ...
        def create_project_location_federation(parent, federation_object = nil, federation_id: nil, request_id: nil, fields: nil, quota_user: nil, options: nil, &block)
          command = make_simple_command(:post, 'v1alpha/{+parent}/federations', options)
          command.request_representation = Google::Apis::MetastoreV1alpha::Federation::Representation
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google::Apis::MetastoreV1alpha::Federation] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google::Apis::MetastoreV1alpha::Federation]
        #
        # @raise [Google::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def get_project_location_federation(name, fields: nil, quota_user: nil, options: nil, &block)
          command = make_simple_command(:get, 'v1alpha/{+name}', options)
          command.response_representation = Google::Apis::MetastoreV1alpha::Federation::Representation
          command.response_class = Google::Apis::MetastoreV1alpha::Federation
          command.params['name'] = name unless name.nil?
          command.query['fields'] = fields unless fields.nil?
          command.query['quotaUser'] = quota_user unless quota_user.nil?
          execute_or_queue_command(command, &block)
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google::Apis::MetastoreV1alpha::ListFederationsResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google::Apis::MetastoreV1alpha::ListFederationsResponse]
        #
        # @raise [Google::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def list_project_location_federations(parent, filter: nil, order_by: nil, page_size: nil, page_token: nil, fields: nil, quota_user: nil, options: nil, &block)
          command = make_simple_command(:get, 'v1alpha/{+parent}/federations', options)
          command.response_representation = Google::Apis::MetastoreV1alpha::ListFederationsResponse::Representation
          command.response_class = Google::Apis::MetastoreV1alpha::ListFederationsResponse
          command.params['parent'] = parent unless parent.nil?
          command.query['filter'] = filter unless filter.nil?
        ...
        # @param [Google::Apis::MetastoreV1alpha::CancelOperationRequest] cancel_operation_request_object
        # @param [String] fields
        #   Selector specifying which fields to include in a partial response.
        # @param [String] quota_user
        #   Available to use for quota purposes for server-side applications. Can be any
        ...
        def cancel_operation(name, cancel_operation_request_object = nil, fields: nil, quota_user: nil, options: nil, &block)
          ...
          command.request_representation = Google::Apis::MetastoreV1alpha::CancelOperationRequest::Representation
        ...
        # @param [Google::Apis::MetastoreV1alpha::CancelMigrationRequest] cancel_migration_request_object
        # @param [String] fields
        #   Selector specifying which fields to include in a partial response.
        # @param [String] quota_user
        #   Available to use for quota purposes for server-side applications. Can be any
        ...
        def cancel_service_migration(service, cancel_migration_request_object = nil, fields: nil, quota_user: nil, options: nil, &block)
          command = make_simple_command(:post, 'v1alpha/{+service}:cancelMigration', options)
          command.request_representation = Google::Apis::MetastoreV1alpha::CancelMigrationRequest::Representation
        ...
        #   location_id`/services/`service_id`.
        # @param [Google::Apis::MetastoreV1alpha::CompleteMigrationRequest] complete_migration_request_object
        # @param [String] fields
        #   Selector specifying which fields to include in a partial response.
        # @param [String] quota_user
        #   Available to use for quota purposes for server-side applications. Can be any
        ...
        def complete_service_migration(service, complete_migration_request_object = nil, fields: nil, quota_user: nil, options: nil, &block)
          command = make_simple_command(:post, 'v1alpha/{+service}:completeMigration', options)
          command.request_representation = Google::Apis::MetastoreV1alpha::CompleteMigrationRequest::Representation
        ...
        #   location_id`/services/`service_id`.
        # @param [Google::Apis::MetastoreV1alpha::StartMigrationRequest] start_migration_request_object
        # @param [String] fields
        #   Selector specifying which fields to include in a partial response.
        # @param [String] quota_user
        #   Available to use for quota purposes for server-side applications. Can be any
        ...
        def start_service_migration(service, start_migration_request_object = nil, fields: nil, quota_user: nil, options: nil, &block)
          command = make_simple_command(:post, 'v1alpha/{+service}:startMigration', options)
          command.request_representation = Google::Apis::MetastoreV1alpha::StartMigrationRequest::Representation
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google::Apis::MetastoreV1alpha::MigrationExecution] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        ...
        def get_project_location_service_migration_execution(name, fields: nil, quota_user: nil, options: nil, &block)
          command = make_simple_command(:get, 'v1alpha/{+name}', options)
          command.response_representation = Google::Apis::MetastoreV1alpha::MigrationExecution::Representation
          command.response_class = Google::Apis::MetastoreV1alpha::MigrationExecution
          command.params['name'] = name unless name.nil?
          command.query['fields'] = fields unless fields.nil?
          command.query['quotaUser'] = quota_user unless quota_user.nil?
          execute_or_queue_command(command, &block)
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google::Apis::MetastoreV1alpha::ListMigrationExecutionsResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google::Apis::MetastoreV1alpha::ListMigrationExecutionsResponse]
        #
        # @raise [Google::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def list_project_location_service_migration_executions(parent, filter: nil, order_by: nil, page_size: nil, page_token: nil, fields: nil, quota_user: nil, options: nil, &block)
          command = make_simple_command(:get, 'v1alpha/{+parent}/migrationExecutions', options)
          command.response_representation = Google::Apis::MetastoreV1alpha::ListMigrationExecutionsResponse::Representation
          command.response_class = Google::Apis::MetastoreV1alpha::ListMigrationExecutionsResponse
          command.params['parent'] = parent unless parent.nil?
          command.query['filter'] = filter unless filter.nil?
          command.query['orderBy'] = order_by unless order_by.nil?
          command.query['pageSize'] = page_size unless page_size.nil?
