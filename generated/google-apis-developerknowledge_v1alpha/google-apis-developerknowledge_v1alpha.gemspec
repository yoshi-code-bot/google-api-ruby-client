require File.expand_path("lib/google/apis/developerknowledge_v1alpha/gem_version", __dir__)
gem_version = Google::Apis::DeveloperknowledgeV1alpha::GEM_VERSION

Gem::Specification.new do |gem|
  gem.name = "google-apis-developerknowledge_v1alpha"
  gem.version = gem_version
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for Developer Knowledge API V1alpha"
  gem.description =
      "This is the simple REST client for Developer Knowledge API V1alpha." \
      ...
      " this client to access the Developer Knowledge API, but note that some" \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-developerknowledge_v1alpha/v#{gem_version}",
