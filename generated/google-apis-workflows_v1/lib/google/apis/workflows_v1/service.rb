  ...
  module Apis
    module WorkflowsV1
      ...
      class WorkflowsService < Google::Apis::Core::BaseService
        ...
        # @yieldparam result [Google::Apis::WorkflowsV1::Location] parsed result object
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google::Apis::WorkflowsV1::ListLocationsResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google::Apis::WorkflowsV1::Empty] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google::Apis::WorkflowsV1::Operation] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google::Apis::WorkflowsV1::ListOperationsResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google::Apis::WorkflowsV1::Workflow] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google::Apis::WorkflowsV1::ListWorkflowsResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
