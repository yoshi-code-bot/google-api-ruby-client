require File.expand_path("lib/google/apis/searchads360_v23/gem_version", __dir__)
gem_version = Google::Apis::Searchads360V23::GEM_VERSION

Gem::Specification.new do |gem|
  gem.name = "google-apis-searchads360_v23"
  gem.version = gem_version
  gem.authors = ["Google LLC"]
  gem.email = "googleapis-packages@google.com"
  gem.summary = "Simple REST client for Search Ads 360 Reporting API V23"
  gem.description =
      "This is the simple REST client for Search Ads 360 Reporting API V23." \
  ...
  gem.metadata = {
    ...
    "documentation_uri" => "https://googleapis.dev/ruby/google-apis-searchads360_v23/v#{gem_version}",
