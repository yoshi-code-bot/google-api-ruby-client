...
module Google
  module Apis
    module CloudlocationfinderV1
      ...
      #
      #    Cloudlocationfinder = Google::Apis::CloudlocationfinderV1 # Alias the module
      ...
      class CloudLocationFinderService < Google::Apis::Core::BaseService
        ...
        def initialize
          super(DEFAULT_ENDPOINT_TEMPLATE, '',
                client_name: 'google-apis-cloudlocationfinder_v1',
                client_version: Google::Apis::CloudlocationfinderV1::GEM_VERSION)
          @batch_path = 'batch'
        end
        ...
        # @yieldparam result [Google::Apis::CloudlocationfinderV1::Location] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google::Apis::CloudlocationfinderV1::Location]
        #
        ...
        def get_project_location(name, fields: nil, quota_user: nil, options: nil, &block)
          ...
          command.response_representation = Google::Apis::CloudlocationfinderV1::Location::Representation
          command.response_class = Google::Apis::CloudlocationfinderV1::Location
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google::Apis::CloudlocationfinderV1::ListLocationsResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google::Apis::CloudlocationfinderV1::ListLocationsResponse]
        #
        # @raise [Google::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def list_project_locations(name, extra_location_types: nil, filter: nil, page_size: nil, page_token: nil, fields: nil, quota_user: nil, options: nil, &block)
          ...
          command.response_representation = Google::Apis::CloudlocationfinderV1::ListLocationsResponse::Representation
          command.response_class = Google::Apis::CloudlocationfinderV1::ListLocationsResponse
          command.params['name'] = name unless name.nil?
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google::Apis::CloudlocationfinderV1::CloudLocation] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google::Apis::CloudlocationfinderV1::CloudLocation]
        #
        # @raise [Google::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def get_project_location_cloud_location(name, fields: nil, quota_user: nil, options: nil, &block)
          command = make_simple_command(:get, 'v1/{+name}', options)
          command.response_representation = Google::Apis::CloudlocationfinderV1::CloudLocation::Representation
          command.response_class = Google::Apis::CloudlocationfinderV1::CloudLocation
          command.params['name'] = name unless name.nil?
          command.query['fields'] = fields unless fields.nil?
          command.query['quotaUser'] = quota_user unless quota_user.nil?
          execute_or_queue_command(command, &block)
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google::Apis::CloudlocationfinderV1::ListCloudLocationsResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google::Apis::CloudlocationfinderV1::ListCloudLocationsResponse]
        #
        # @raise [Google::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def list_project_location_cloud_locations(parent, filter: nil, page_size: nil, page_token: nil, fields: nil, quota_user: nil, options: nil, &block)
          command = make_simple_command(:get, 'v1/{+parent}/cloudLocations', options)
          command.response_representation = Google::Apis::CloudlocationfinderV1::ListCloudLocationsResponse::Representation
          command.response_class = Google::Apis::CloudlocationfinderV1::ListCloudLocationsResponse
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [Google::Apis::CloudlocationfinderV1::SearchCloudLocationsResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [Google::Apis::CloudlocationfinderV1::SearchCloudLocationsResponse]
        #
        # @raise [Google::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [Google::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [Google::Apis::AuthorizationError] Authorization is required
        def search_project_location_cloud_locations(parent, page_size: nil, page_token: nil, query: nil, source_cloud_location: nil, fields: nil, quota_user: nil, options: nil, &block)
          command = make_simple_command(:get, 'v1/{+parent}/cloudLocations:search', options)
          command.response_representation = Google::Apis::CloudlocationfinderV1::SearchCloudLocationsResponse::Representation
          command.response_class = Google::Apis::CloudlocationfinderV1::SearchCloudLocationsResponse
          command.params['parent'] = parent unless parent.nil?
          command.query['pageSize'] = page_size unless page_size.nil?
          command.query['pageToken'] = page_token unless page_token.nil?
